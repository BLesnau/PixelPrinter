...
namespace Pixel_Printer
{
   ...
   public sealed partial class MainPage : Page
   {
      ...
      public MainPage()
      {
         ...
         {
            var commObj = UnityEngine.GameObject.FindObjectOfType<WSAComm>();
            if ( commObj )
            {
               commObj.DoStuff( DoLogin );
            }
         }, true );
      }

      private void WebBrowserOnNavigationStarting( WebView sender, WebViewNavigationStartingEventArgs args )
      {
         int i = 0;
         i++;
      }

      private void WebBrowserOnNavigationFailed( object sender, WebViewNavigationFailedEventArgs webViewNavigationFailedEventArgs )
      {
         int i = 0;
         i++;
      }

      private void WebBrowserOnNavigationCompleted( WebView sender, WebViewNavigationCompletedEventArgs args )
      {
         int i = 0;
         i++;
      }
         ...
         appCallbacks.InvokeOnUIThread( () =>
          {
             ...
             try
             {
                WebBrowser.NavigationCompleted += WebBrowserOnNavigationCompleted;
      ...
      protected override void OnNavigatedTo( NavigationEventArgs e )
      {
         ...
         //{
         //webView.Navigate( new Uri( "http://www.techsmith.com" ) );
         //}, false);
         //} );
      }
      ...
      private void ButtonBase_OnClick( object sender, RoutedEventArgs e )
      {
        // AppCallbacks appCallbacks = AppCallbacks.Instance;
         //appCallbacks.InvokeOnUIThread( () =>
         // {
             webView.NavigationCompleted += WebBrowserOnNavigationCompleted;
             webView.NavigationFailed += WebBrowserOnNavigationFailed;
             webView.NavigationStarting += WebBrowserOnNavigationStarting;
             webView.Navigate( new Uri( "http://www.techsmith.com" ) );
         // }, true );
      }
   }
